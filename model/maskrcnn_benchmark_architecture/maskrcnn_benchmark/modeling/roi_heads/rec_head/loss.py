...
class RRPNRecLossComputation(object):
    def __init__(self, proposal_matcher, discretization_size):
        ...
        if _DEBUG:
            #pro_name = './maskrcnn_benchmark_architecture/data_cache/alphabet_90Klex_IC13_IC15_Syn800K_pro.txt' # alphabet_90Klex_IC13_IC15_Syn800K_pro.txt
            pro_name = './maskrcnn_benchmark_architecture/data_cache/alphabet_IC13_IC15_pro.txt'
            self.show_cnt = 0
