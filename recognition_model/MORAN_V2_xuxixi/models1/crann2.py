...
class CRANN(nn.Module):
    def __init__(self, crann_config, n_class):
        ...
        #self.cnn = ConvNets.__dict__[cnn_conf['MODEL']](imgH=32, nc=3) #gor ghost
