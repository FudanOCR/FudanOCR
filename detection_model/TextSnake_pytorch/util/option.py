...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--gpu_list', default='0', type=str, help="gpu_list, split by ',' ")
        self.parser.add_argument('--backbone', default='vgg', type=str, choices=['vgg', 'resnet', 'resnet_gcn', 'resnet_gcn_new', 'resnet_gcn_ms', 'resnet_gcn_ms2'], help='Backbone name')
        self.parser.add_argument('--dataset', default='ICDAR19', type=str, choices=['ArT_train', 'LSVT_full_train'], help='Dataset name')
        self.parser.add_argument('--resume', default=None, type=str, help='Path to target resume checkpoint')
        self.parser.add_argument('--num_workers', default=8, type=int, help='Number of workers used in dataloading')    # 8
        ...
        self.parser.add_argument('--summary_dir', default='./summary/', help='Path to save visualization images')
        ...
        self.parser.add_argument('--max_epoch', default=5, type=int, help='Max epochs')
        ...
        self.parser.add_argument('--summary_freq', default=100, type=int, help='do summary every # iterations')
        self.parser.add_argument('--display_freq', default=10, type=int, help='display training metrics every # iterations')
        ...
        self.parser.add_argument('--means', type=float, default=(0.474, 0.445, 0.418), nargs='+', help='mean')
        # self.parser.add_argument('--stds', type=float, default=(0.244, 0.238, 0.238), nargs='+', help='std')
        self.parser.add_argument('--stds', type=float, default=(1., 1., 1.), nargs='+', help='std')
        ...
        self.parser.add_argument('--output_dir', default='./output/', help='Path to save detect results')
        self.parser.add_argument('--multi_scale', action='store_true', help='Whether to using multi-scale testing')
