...
class ICDAR2013Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, anno_dir, use_difficlut=False, transforms=None)
        # data_dirs = [train_data_dir]
        # gt_dirs = [train_gt_dir]
        self.root = data_dir  # data_dirs
        self.anno_dir = anno_dir  # gt_dirs
...
class ICDAR2015TRAIN(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, anno_dir, use_difficult=False, transforms=None):
        self.root = data_dir
