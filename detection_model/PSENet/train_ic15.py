import sys
sys.path.append('/home/cjy/PSENet-master/util')
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for batch_idx, (imgs, gt_texts, gt_kernels, training_masks) in enumerate(train_loader):
        ...
        if batch_idx %100 == 0:
            writer.add_scalar('loss_text', loss_text, batch_idx+epoch*len(train_loader))
            writer.add_scalar('loss_kernel', loss_kernel, batch_idx + epoch * len(train_loader))
            writer.add_scalar('total_loss', loss, batch_idx + epoch * len(train_loader))
...
def save_checkpoint(state, checkpoint='checkpoint', filename='_checkpoint.pth.tar', epoch=0):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrain', nargs='?', type=str, default='/home/cjy/PSENet-master/resnet50.pth',
                        help='Path to previous saved model to restart from')
    parser.add_argument('--checkpoint', default='/home/cjy/PSENet-master/workspace/', type=str, metavar='PATH',
