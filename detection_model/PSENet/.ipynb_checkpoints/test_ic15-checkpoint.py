...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', nargs='?', type=str, default='/workspace/mnt/group/general-reg/denglei/code/PSENet-master/models/weights/ic15_res50_pretrain_ic17.pth',    
