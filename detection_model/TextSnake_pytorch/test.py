...
def inference(model, detector, test_loader):
    gt_json_path = os.path.join('/home/shf/fudan_ocr_system/datasets/', cfg.dataset, 'train_labels.json')
...
def main():
    testset = TotalText(
        ...
        ignore_list='/home/shf/fudan_ocr_system/datasets/ICDAR19/ignore_list.txt',
        is_training=False,
