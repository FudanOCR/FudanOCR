import numpy as np
import cv2
from model.detection_model.TextSnake_pytorch.util.misc import fill_hole, regularize_sin_cos
from model.detection_model.TextSnake_pytorch.util.misc import norm2
import random
