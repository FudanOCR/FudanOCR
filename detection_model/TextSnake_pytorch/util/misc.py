...
def split_edge_seqence(points, long_edge, n_parts):
    ...
    length_per_part = total_length / (n_parts if n_parts < int(total_length) else int(total_length))
    ...
    for i in range(1, n_parts):
        ...
        while cur_node < len(long_edge)-1 and cur_end > point_cumsum[cur_node + 1]:
            cur_node += 1
