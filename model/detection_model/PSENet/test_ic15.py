    ...
    with torch.no_grad():
        for idx, (org_img, img) in enumerate(test_loader):
            ...
            for i in range(1, label_num):
                points = np.array(np.where(label == i)).transpose((1, 0))[:, ::-1] #the pixels belong to connected components i
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', nargs='?', type=str, default='/workspace/mnt/group/general-reg/denglei/code/PSENet-master/models/weights_LSVT/_pretrain_LSVT/epoch_19_checkpoint.pth.tar',
