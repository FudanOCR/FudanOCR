...
def make_roi_textsnake_post_processor(cfg):
    if cfg.MODEL.ROI_TEXTSNAKE_HEAD.POSTPROCESS_MASKS:
        mask_threshold = cfg.MODEL.ROI_TEXTSNAKE_HEAD.POSTPROCESS_MASKS_THRESHOLD
