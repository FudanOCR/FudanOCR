...
class CTW1500Loader(data.Dataset):
    def __init__(self, data_dir, gt_dir, is_transform=False, img_size=None, kernel_num=7, min_scale=0.4):
        ...
        data_dirs = data_dir#[ctw_train_data_dir]
        gt_dirs = gt_dir#[ctw_train_gt_dir]
