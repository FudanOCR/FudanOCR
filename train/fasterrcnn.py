...
def train_fasterrcnn(config):

    import sys
    sys.path.append('./maskrcnn_benmark_architecture')
    import os
    #print (os.getcwd()) #查看所在路径
    from maskrcnn_benchmark.utils.env import setup_environment
    # from maskrcnn_benchmark import *
    ...
    def start():
        ...
        model = train(cfg, args.local_rank, args.distributed, args.ft_flag)
