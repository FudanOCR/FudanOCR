...
# gt_json_path = '/workspace/mnt/group/ocr/qiutairu/dataset/ArT_train/train_labels.json'
input_json_path = '/workspace/mnt/group/ocr/qiutairu/code/mask_rrpn/save/lsvt_0411/inference/LSVT_demo/result.json'
gt_json_path = '/workspace/mnt/group/ocr/qiutairu/dataset/LSVT_full_train/train_labels.json'
save_img_path = '/workspace/mnt/group/ocr/qiutairu/code/mask_rrpn/vis/lsvt_0411_test'
iou_threshold = 0.5
...
if __name__ == '__main__':
    ...
    for idx, (input_img_key, input_cnts) in enumerate(input_dict.items()):
        ...
        if local_precision == 0 or local_recall == 0 or 2 * local_precision * local_recall / (local_precision + local_recall) <= 0.5:
